...
namespace NinjaKiwi.LifeQuest.Common.Authorization
{
    ...
    /// </summary>
    public class LifeQuestPermissionChecker : ICustomPermissionChecker, ILifeQuestPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public LifeQuestPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
