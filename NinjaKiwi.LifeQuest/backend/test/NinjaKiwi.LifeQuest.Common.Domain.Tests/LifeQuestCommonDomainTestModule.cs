...
using NinjaKiwi.LifeQuest.Tests.DependencyInjection;
using Shesha;
...
namespace NinjaKiwi.LifeQuest.Common.Tests
{
    [DependsOn(
    ...
    public class LifeQuestCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public LifeQuestCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
